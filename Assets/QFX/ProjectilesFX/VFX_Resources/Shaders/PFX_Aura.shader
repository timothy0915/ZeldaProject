		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float2 uv016 = i.texcoord.xy * (_Tiling).xy + float2( 0,0 );
					float2 panner12 = ( mulTime155 * float2( 1,0 ) + uv016);
					float temp_output_151_0 = pow( tex2D( _MainTex, panner12 ).r , _MainTexturePower );
					float mulTime156 = _Time.y * _TimeScale2;
					float2 uv081 = i.texcoord.xy * (_Tiling).zw + float2( 0,0 );
					float2 panner77 = ( mulTime156 * float2( 1,0 ) + uv081);
					...
					float staticSwitch139 = saturate( uv017.x );
					#else
					float staticSwitch139 = 1.0;
					#endif
					float4 temp_output_4_0 = ( _TintColor * saturate( staticSwitch136 ) * i.color * staticSwitch139 );
					float4 appendResult32 = (float4(( _EmissiveMultiply * (temp_output_4_0).rgb ) , saturate( ( (temp_output_4_0).a * _OpacityMultiply ) )));
...
/*ASEBEGIN
Version=18301
20;440;1523;276;2294.548;-437.5842;3.801455;True;False
Node;AmplifyShaderEditor.Vector4Node;59;-2871.087,300.7404;Float;False;Property;_Tiling;Tiling;6;0;Create;True;0;0;False;0;False;1,1,1,1;0.4,2,0.6,4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;153;-2505.401,531.0943;Inherit;False;Property;_TimeScale1;Time Scale 1;7;0;Create;True;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;154;-2507.218,622.1009;Inherit;False;Property;_TimeScale2;Time Scale 2;8;0;Create;True;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;150;-1780.479,714.7845;Inherit;False;Property;_MainTexturePower;Main Texture Power;5;0;Create;True;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-1858.018,296.8806;Inherit;True;Property;_NoiseTexture;Noise Texture;1;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;136;-1088.318,291.9145;Inherit;False;Property;_Blend;Blend;2;0;Create;True;0;0;False;0;False;1;0;0;True;;KeywordEnum;3;None;Add;Lerp;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;158;806.8719,638.1957;Inherit;False;Property;_OpacityMultiply;Opacity Multiply;4;0;Create;True;0;0;False;0;False;1;1.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;817.8971,285.9022;Inherit;False;Property;_EmissiveMultiply;Emissive Multiply;3;0;Create;True;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;157;1068.995,307.3964;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;138;-571.1035,-10.14218;Inherit;False;Property;_UseCutout;Use Cutout;10;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;172;-1179.968,921.4976;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalizeNode;173;-998.7545,1069.763;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PowerNode;170;-307.9374,977.3307;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;99;-138.2888,862.8469;Inherit;False;Constant;_Float2;Float 2;9;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;168;-629.6105,926.6975;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;171;-632.9982,1157.777;Inherit;False;Property;_FresnelPower;Fresnel Power;13;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;162;-1163.493,1071.822;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;167;-781.9937,926.1195;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;98;4.42986,861.2578;Inherit;False;Property;_UseFresnel;Use Fresnel;9;0;Create;True;0;0;False;0;False;1;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;146;1721.52,497.3652;Float;False;True;-1;2;ASEMaterialInspector;0;7;QFX/ProjectilesFX/Aura;0b6a9f8b4f707c74ca64c0be8e590de0;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;1;5;True;145;0;True;147;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;2;False;-1;True;True;True;True;False;0;False;-1;False;False;False;False;True;2;False;-1;True;3;False;-1;False;True;4;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;0;;0;0;Standard;0;0;1;True;False;;0
...
ASEEND*/
//CHKSM=74CF3C8268C2A374DC3E1D42EFE58A0F07FD6630